...
public class US15_ApiStepDefinitions {
    ...
    @Given("YY Kullanici {string} Medunna Api Endpointinden hastalari goruntuler")
    ...
    @Given("YY Kullanici {string} Medunna Api Endpointine,{string} li hastanin bilgilerinin  {string}, {string}, {string}, {string}, {string} oldugunu dogrular")
