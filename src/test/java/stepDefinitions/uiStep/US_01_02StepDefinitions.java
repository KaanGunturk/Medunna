...
public class US_01_02StepDefinitions {
    ...
    public void kullanıcıHttpsMedunnaComAdresineGidilir() {
    }
    ...
    @And("SSN bolumune ucuncu ve besinci rakamdan sonra {string} girer")
    public void ssnBolumuneUcuncuVeBesinciRakamdanSonraGirer(String arg0) {
    }
